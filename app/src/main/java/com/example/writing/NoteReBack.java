...
public class NoteReBack extends Activity {
    ...
    public MyAdpater myAdpater;
    public int currentPositon=-1;
    public Button currentButton;
    public class MyAdpater extends BaseAdapter
    {
        private List<Han> listAdapter;
        private Context contextMyShelf;
        public MyAdpater(Context context, List<Han> list)
        {
    ...
    public class ProgressBarAsyncTask extends AsyncTask<Void, Integer, Void> {
        List<List<WordPoint>> points;
        List<List<Integer>> colors;

        public ProgressBarAsyncTask(List<List<WordPoint>>points,List<List<Integer>>colors)
        {
            this.points=points;
            this.colors=colors;
        }
